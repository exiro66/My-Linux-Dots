...
yay -S --needed --noconfirm zen-browser-bin loupe qbittorrent hyprmod lutris wine winetricks nautilus gnome-calculator gnome-disk-utility easyeffects audacity tela-circle-icon-theme caelestia-sddm-locklike-git papirus-folders
