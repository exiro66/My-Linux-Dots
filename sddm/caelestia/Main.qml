...
Rectangle {
    ...
    property real welcomeBgBlurAmount: 25
    property bool welcomeBgBlur: true
    property real mainCardBlurAmount: 25
    ...
    property bool mainCardBgBlur: true
    ...
    Connections {
// ... (no toques las líneas intermedias de Connections) ...
    }
    ...
    AnimatedImage {
        ...
        anchors.fill: parent
        source: "background.png" // Cambiado de "assets/background" a tu archivo directo
        ...
        Rectangle {
            anchors.fill: parent
            color: "#000000"
            opacity: firstInput ? 0 : 0.2 // Bajado de 0.4 a 0.2 para que tu wallpaper dark.png no se oscurezca tanto al escribir
