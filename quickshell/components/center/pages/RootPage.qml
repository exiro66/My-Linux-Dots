        ...
        Reveal {
            ...
            Grid {
                ...
                ControlTile {
                    ...
                    label: "Bluetooth"
                    sublabel: Bluetooth.summary
                    active: Bluetooth.powered
                    drill: true
                    quick: Bluetooth.available
                    onToggled: Bluetooth.togglePower()
                    onOpened: CenterNav.go("bluetooth")
                }
                ControlTile {
                    width: page.tileWidth
                ...
                ControlTile {
                    ...
                    glyph: Icons.battery
                    label: "Battery"
                    sublabel: PowerProfiles.summary
                    active: true
                    drill: true
                    onOpened: CenterNav.go("powerprofiles")
                }
                ControlTile {
                    width: page.tileWidth
                ...
                ControlTile {
                    ...
                    glyph: Icons.columns
                    label: "Layout"
                    sublabel: Layout.currentLabel
                    active: true
                    drill: true
                    onOpened: CenterNav.go("layout")
                }
                ControlTile {
                    width: page.tileWidth
                    glyph: Icons.power
