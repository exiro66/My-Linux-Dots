...
Item {
    ...
    readonly property real _activeHeight: {
        ...
        case "powerprofiles":
            return powerProfilesPage.implicitHeight;
        case "layout":
            return layoutPage.implicitHeight;
        case "calendar":
    ...
    Connections {
        ...
        function onCenterVisibleChanged() {
            ...
            Bluetooth.polling = UiState.centerVisible;
            PowerProfiles.polling = UiState.centerVisible;
            Layout.polling = UiState.centerVisible;
            Brightness.polling = UiState.centerVisible;
    ...
    Item {
        ...
        Item {
            ...
            BluetoothPage {
                id: bluetoothPage
                width: parent.width
                visible: CenterNav.page === "bluetooth"
            }
            AudioPage {
                id: audioPage
                width: parent.width
            ...
            PowerProfilesPage {
                id: powerProfilesPage
                width: parent.width
                visible: CenterNav.page === "powerprofiles"
            }
            LayoutPage {
                id: layoutPage
                width: parent.width
                visible: CenterNav.page === "layout"
            }
            CalendarPage {
                id: calendarPage
                width: parent.width
