...
-- Tide Island IPC base
local tide = "/usr/bin/quickshell ipc --any-display -p /usr/share/tide-island call"
...
-- TIDE ISLAND
-- ============================================================
hl.bind(mod .. " + A", hl.dsp.exec_cmd(tide .. " tide toggleApplicationLauncher"))
hl.bind(mod .. " + C", hl.dsp.exec_cmd(tide .. " tide toggleControlCenter"))
hl.bind(mod .. " + M", hl.dsp.exec_cmd(tide .. " tide togglePlayer"))
hl.bind(mod .. " + W", hl.dsp.exec_cmd(tide .. " tide toggleWallpaperPicker"))
hl.bind(mod .. " + N", hl.dsp.exec_cmd(tide .. " tide toggleNotificationCenter"))
