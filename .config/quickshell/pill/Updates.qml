...
SettingsSurface {
    ...
    readonly property color badgeTint: statusKind === "error" || statusKind === "offline" ? pill.subTextColor
        : statusKind === "checking" || statusKind === "applying" || statusKind === "idle" || statusKind === "noclone" ? pill.subTextColor
        : Theme.vermLit
                    ...
                    Row {
                        ...
                        component Seg: Rectangle {
                            ...
                            Text {
                                ...
                                anchors.centerIn: parent
                                text: seg.label
                                color: seg.on ? Theme.bright : pill.subTextColor
                                font.family: Theme.font
