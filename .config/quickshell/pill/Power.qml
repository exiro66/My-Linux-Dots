...
PillSurface {
        ...
        Repeater {
            ...
            delegate: Row {
                ...
                Item {
                    ...
                    readonly property color accent: cell.modelData.confirm ? Theme.vermLit : pill.textColor
                    ...
                    GlyphIcon {
                        ...
                        color: tile.holding ? Theme.flameCore : (tile.lit ? tile.accent : pill.iconColor)
                        stroke: 1.9
                    }
    ...
    Text {
        ...
        color: act && act.confirm ? Theme.vermLit : pill.subTextColor
        font.family: Theme.font
