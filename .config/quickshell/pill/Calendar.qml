            ...
            Row {
                ...
                Item {
                    ...
                    Text {
                        ...
                        color: cityArea.containsMouse ? pill.subTextColor : pill.subTextColor
                        font.family: Theme.font
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        GlyphIcon {
                            ...
                            color: navArea.containsMouse ? pill.textColor : pill.iconColor
                            stroke: 1.8
                        }
            ...
            Repeater {
                ...
                Item {
                    ...
                    Text {
                        ...
                        color: wd.weekend ? Theme.faint : pill.subTextColor
                        font.family: Theme.font
                        font.pixelSize: 9 * root.s
                        font.weight: Font.Medium
                        font.letterSpacing: 0.5 * root.s
                        ...
                        color: cell.inMonth
                            ? (cell.current ? Theme.todayWarm
                                : (cell.hasEvent ? Theme.flameGlow
                                    : (cell.weekend ? pill.subTextColor : pill.textColor)))
                            : Theme.ghost
                            ...
                            Rectangle {
                                ...
                                Item {
                                    ...
                                    GlyphIcon {
                                        anchors.fill: parent
                                        name: "close"
                                        color: delArea.containsMouse ? Theme.vermLit : pill.iconColor
                                        stroke: 1.6
                                    }
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Text {
                        anchors.centerIn: parent
                        text: "+"
                        color: addBtn.armed ? Theme.vermLit : pill.iconColor
                        font.family: Theme.font
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            color: root.selEndDate.length > 0 ? pill.textColor : pill.subTextColor
                            font.family: Theme.font
                            font.pixelSize: 11 * root.s
                            font.weight: Font.Medium
                            font.features: { "tnum": 1 }
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: extendBtn.armed ? Theme.vermLit : pill.subTextColor
                        font.family: Theme.font
                ...
                Item {
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "close"
                        color: clearArea.containsMouse ? Theme.vermLit : pill.iconColor
                        stroke: 1.6
                    }
                    MouseArea {
                        id: clearArea
