            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    GlyphIcon {
                        ...
                        color: gchip.on ? Theme.vermLit : pill.iconColor
                        stroke: 1.8
                    }
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        GlyphIcon {
                            ...
                            height: 16 * root.s
                            name: "chevron-right"
                            color: navHover.hovered ? pill.textColor : pill.iconColor
                            stroke: 2.2
                        }
                        ...
                        Rectangle {
                            ...
                            GlyphIcon {
                                ...
                                height: 13 * root.s
                                name: "check"
                                color: wSaveArea.containsMouse ? Theme.vermLit : pill.iconColor
                                stroke: 2
                            }
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            GlyphIcon {
                                ...
                                height: 12 * root.s
                                name: "close"
                                color: cRemoveArea.containsMouse ? Theme.vermLit : pill.iconColor
                                stroke: 2
                            }
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                color: crow.rebinding ? Theme.flameGlow : pill.subTextColor
                                font.family: Theme.font
                                font.pixelSize: 11 * root.s
                                font.weight: Font.Bold
                                font.letterSpacing: 0.3 * root.s
                        ...
                        Rectangle {
                            ...
                            GlyphIcon {
                                ...
                                height: 13 * root.s
                                name: "check"
                                color: cSaveArea.containsMouse ? Theme.vermLit : pill.iconColor
                                stroke: 2
                            }
                        ...
                        GlyphIcon {
                            ...
                            height: 16 * root.s
                            name: "chevron-right"
                            color: cHover.hovered ? pill.textColor : pill.iconColor
                            stroke: 2.2
                        }
                    }
                ...
                Row {
                    ...
                    Item {
                        ...
                        GlyphIcon {
                            anchors.fill: parent
                            name: "chevron-left"
                            color: formBackArea.containsMouse ? pill.textColor : pill.iconColor
                            stroke: 1.8
                        }
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: root.listening ? Theme.flameGlow
                            : (root.formKey.length ? pill.textColor : Theme.faint)
                        font.family: Theme.font
                        font.pixelSize: 11.5 * root.s
