    ...
    Column {
        ...
        Item {
            ...
            Text {
                ...
                color: Battery.charging ? Theme.flameGlow : pill.subTextColor
                font.family: Theme.font
        ...
        Column {
            ...
            Text {
                id: pctText
                text: Battery.pct + "%"
                color: Battery.low ? Theme.vermLit : (Battery.charging ? Theme.flameGlow : pill.textColor)
                font.family: Theme.font
            ...
            Text {
                ...
                text: body
                color: Battery.charging ? Theme.flameCore : pill.subTextColor
                font.family: Theme.font
        ...
        Column {
            ...
            component StatRow: Item {
                ...
                Text {
                    ...
                    anchors.right: parent.right
                    text: stat.value
                    color: stat.warm ? Theme.flameGlow : pill.textColor
                    font.family: Theme.font
