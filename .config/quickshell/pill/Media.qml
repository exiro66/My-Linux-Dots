...
PillSurface {
    ...
    component KanjiSkip: Item {
        ...
        Text {
            ...
            color: skipArea.containsMouse ? pill.textColor : pill.subTextColor
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        radius: 11 * root.s
                        color: isActive ? Qt.alpha(Theme.verm, 0.2) : Qt.alpha(pill.textColor, 0.045)
                        border.width: 1
                        border.color: isActive ? Theme.vermLit : Qt.alpha(pill.textColor, 0.12)
                        ...
                        Row {
                            ...
                            Column {
                                ...
                                Text {
                                    ...
                                    color: bub.isActive ? Theme.bright : pill.subTextColor
                                    font.family: Theme.font
                                ...
                                Text {
                                    ...
                                    color: bub.isActive ? pill.subTextColor : Theme.faint
                                    font.family: Theme.font
