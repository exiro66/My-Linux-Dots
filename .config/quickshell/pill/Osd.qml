...
Item {
    ...
    Item {
        ...
        GlyphIcon {
            ...
            color: root.muted ? pill.subTextColor : pill.iconColor
            stroke: 1.7
        }
        ...
        Text {
            ...
            color: root.muted ? pill.subTextColor : pill.textColor
    ...
    Item {
        ...
        GlyphIcon {
            ...
            color: root.subjectPlaying ? Theme.vermLit : pill.iconColor
        }
    ...
    Item {
        ...
        Rectangle {
            ...
            height: 13 * root.s
            radius: width / 2
            color: root.recordStarted ? Theme.verm : pill.subTextColor
