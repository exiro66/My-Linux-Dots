...
readonly property var allEntries: {
    ...
    for (var i = 0; i < src.length; i++) {
        ...
        var hidden = false;
        for (var j = 0; j < hiddenApps.length; j++) {
            if (id.indexOf(hiddenApps[j]) !== -1) {
                hidden = true;
                break;
            }
        }
    ...
    Item {
        ...
        Item {
            ...
            Text {
                ...
                color: root.calcCopied ? pill.subTextColor : Theme.vermLit
                font.family: Theme.font
...
Image {
    ...
    source: {
        ...
        return "/usr/share/icons/Tela-circle/scalable/apps/" + ic + ".svg";
    }
}
                TextMetrics {
                    id: retMetrics
                ...
                GlyphIcon {
                    ...
                    stroke: 2
                    name: "trash"
                    color: appRow.armed ? "#e0533f" : pill.subTextColor
                ...
                Column {
                    ...
                    Text {
                        ...
                        color: appRow.selected ? pill.subTextColor : Theme.faint
                        font.family: Theme.font
                        font.pixelSize: 10.5 * root.s
                        elide: Text.ElideRight
                    }
