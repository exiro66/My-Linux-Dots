    ...
    component MenuRow: Item {
        ...
        Rectangle {
            ...
            Text {
                ...
                color: !mrow.entryData.enabled ? pill.subTextColor
                    : (mrowArea.containsMouse ? pill.textColor : pill.textColorMenu)
            ...
            GlyphIcon {
                ...
                height: 10 * tray.s
                name: "chevron-right"
                color: mrow.expanded ? Theme.vermLit : pill.iconColor
                stroke: 2
