...
PillSurface {
    ...
    component NotifRow: Rectangle {
        ...
        Text {
            ...
            color: nrow.critical ? pill.textColor : pill.subTextColor
        ...
        Row {
            ...
            Item {
                ...
                GlyphIcon {
                    ...
                    name: "close"
                    color: nrowXArea.containsMouse ? pill.textColor : pill.subTextColor
                    stroke: 1.9
                    Behavior on opacity { NumberAnimation { duration: Motion.fast } }
                        ...
                        Column {
                            ...
                            Rectangle {
                                ...
                                GlyphIcon {
                                    ...
                                    name: "close"
                                    color: headXArea.containsMouse ? pill.textColor : pill.subTextColor
                                    stroke: 1.9
                                    Behavior on opacity { NumberAnimation { duration: Motion.fast } }
