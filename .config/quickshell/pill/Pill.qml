...
readonly property color textColor: pill.notchMode === "light" ? "#000000" : "#e6d6cb"
readonly property color subTextColor: pill.notchMode === "light" ? "#333333" : "#8a7d74"
readonly property color iconColor: pill.notchMode === "light" ? "#000000" : "#cdbfb4"

FileView {
    id: notchFile
    path: Quickshell.env("HOME") + "/.cache/ricelin/notch-mode"
    blockLoading: true
    watchChanges: true
    onFileChanged: reload()
    onLoaded: pill.notchMode = text().trim() === "light" ? "light" : "dark"
}
...
readonly property bool expanded: surfaceOpen || held || hoverLatch || alwaysExpanded
    ...
    readonly property real restW: 105 * s
    readonly property real restH: 35 * s
...
topRightRadius: pill.pillMode === "dynamic" ? pill.morphRadius : 0
    ...
    border.color: Theme.border
gradient: Gradient {
    GradientStop { position: 0.0; color: Qt.alpha(pill.notchMode === "light" ? "#ffffff" : "#000000", Flags.pillOpacity) }
    GradientStop { position: 1.0; color: Qt.alpha(pill.notchMode === "light" ? "#ffffff" : "#000000", Flags.pillOpacity) }
}
        ...
        Column {
            ...
            Text {
                ...
                text: pill.dragStage === "bad" ? "Can't install this"
                    ...
                    : "Drop to install")))
                color: pill.notchMode === "light" ? "#000000" : pill.textColor
    ...
    Item {
        ...
        Row {
            ...
            GlyphIcon {
                ...
                color: osd.kind === "volume" && osd.muted ? pill.subTextColor : pill.iconColor
                stroke: 1.7
            }
            ...
            Text {
                ...
                color: osd.kind === "volume" && osd.muted ? pill.subTextColor : pill.textColor
                font.family: Theme.font
                font.pixelSize: 10.5 * pill.s
                font.weight: Font.DemiBold
                font.features: ({ "tnum": 1 })
...
anchors.centerIn: parent
            ...
            Row {
                ...
                Row {
                    ...
                    Item {
                        ...
                        GlyphIcon {
                            anchors.fill: parent
                            name: "bluetooth"
                            color: btArea.containsMouse ? pill.textColor
                                : (pill.btOn ? pill.iconColor : Qt.alpha(pill.iconColor, 0.4))
                            stroke: 1.7
                        }
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            anchors.centerIn: parent
                            text: Battery.pct + "%"
                            color: Battery.low ? Theme.vermLit : (Battery.charging ? Theme.flameGlow : pill.subTextColor)
                            font.family: Theme.font
                            font.pixelSize: 13 * pill.s
                ...
                Item {
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "inbox"
                        color: inboxArea.containsMouse ? pill.textColor : pill.iconColor
                        stroke: 1.7
                    }
                ...
                Item {
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "mixer"
                        color: mixerArea.containsMouse ? pill.textColor : pill.iconColor
                        stroke: 1.7
                    }
                ...
                Item {
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "monitor"
                        color: sysmonArea.containsMouse ? pill.textColor : pill.iconColor
                        stroke: 1.7
                    }
                ...
                Item {
                    ...
                    GlyphIcon {
                        ...
                        name: "video"
                        color: recorderArea.containsMouse ? pill.textColor : pill.iconColor
                        stroke: 1.7
                    }
                ...
                Item {
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "cog"
                        color: settingsArea.containsMouse ? pill.textColor : pill.iconColor
                        stroke: 1.6
                    }
                ...
                Item {
                    ...
                    GlyphIcon {
                        anchors.fill: parent
                        name: "shutdown"
                        color: powerArea.containsMouse ? pill.textColor : pill.iconColor
                        stroke: 1.7
                    }
    ...
    Item {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        GlyphIcon {
                            ...
                            color: qSrcArea.containsMouse ? Theme.vermLit : pill.iconColor
                            stroke: 1.7
                        }
                        Text {
                            height: 16 * pill.s
                            ...
                            color: qSrcArea.containsMouse ? pill.textColor : pill.subTextColor
                            font.family: Theme.font
                            font.pixelSize: 11 * pill.s
        ...
        GlyphIcon {
            ...
            height: 12 * pill.s
            name: "chevron-left"
            color: qBackArea.containsMouse ? pill.textColor : Theme.faint
            stroke: 2
