        ...
        Row {
            ...
            Item {
                ...
                GlyphIcon {
                    ...
                    anchors.fill: parent
                    name: "reboot"
                    color: root.scanning ? Theme.flameGlow : (reloadArea.containsMouse ? pill.textColor : pill.iconColor)
                    stroke: 1.8
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                color: netItem.isActive ? Theme.vermLit : pill.subTextColor
                                font.family: Theme.font
                            ...
                            Row {
                                ...
                                Item {
                                    ...
                                    GlyphIcon {
                                        anchors.fill: parent
                                        name: "lock-outline"
                                        color: netItem.isActive ? Theme.vermLit : pill.iconColor
                                        stroke: 1.9
                                    }
                                }
                        ...
                        Item {
                            ...
                            Row {
                                ...
                                GlyphIcon {
                                    ...
                                    height: 14 * root.s
                                    name: "return"
                                    color: enterArea.containsMouse ? pill.textColor : Theme.vermLit
                                    stroke: 1.8
        ...
        Column {
            ...
            component CredRow: Item {
                ...
                Text {
                    ...
                    color: cr.value.length ? (cr.secret ? Theme.flameCore : pill.textColor) : Theme.faint
                    font.family: Theme.font
            ...
            Rectangle {
                ...
                GlyphIcon {
                    ...
                    height: 17 * root.s
                    name: "hotspot"
                    color: root.hsActive ? Theme.flameGlow : pill.iconColor
                    stroke: 1.7
                }
                ...
                Column {
                    ...
                    Text {
                        ...
                        color: root.hsActive ? Theme.flameGlow : pill.subTextColor
                        font.family: Theme.font
                        font.pixelSize: 9.5 * root.s
                        font.weight: Font.Medium
                    }
