...
Item {
    ...
    readonly property color offColor: on ? Qt.alpha(pill.iconColor, 0.4) : Qt.alpha(pill.iconColor, 0.18)
    ...
    Shape {
        ...
        ShapePath {
            strokeColor: root.litCount >= 1 ? pill.iconColor : root.offColor
        ...
        ShapePath {
            strokeColor: root.litCount >= 2 ? pill.iconColor : root.offColor
            fillColor: "transparent"
            strokeWidth: root.arcStroke
            capStyle: ShapePath.RoundCap
        ...
        ShapePath {
            strokeColor: root.litCount >= 3 ? pill.iconColor : root.offColor
            fillColor: "transparent"
            strokeWidth: root.arcStroke
            capStyle: ShapePath.RoundCap
        ...
        ShapePath {
            ...
            fillColor: root.litCount >= 1 ? pill.iconColor : root.offColor
