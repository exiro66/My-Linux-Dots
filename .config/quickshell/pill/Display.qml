...
SettingsSurface {
    ...
    component CardRow: Item {
        ...
        GlyphIcon {
            ...
            color: crow.focused ? pill.textColor : pill.subTextColor
            stroke: 1.8
        }
            ...
            Item {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        border.width: 1
                        border.color: tile.moved ? Qt.alpha(Theme.vermLit, 0.7) : (tile.sel ? pill.textColor : Theme.hairSoft)
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                color: tile.sel ? pill.textColor : pill.subTextColor
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                anchors.centerIn: parent
                                text: "Apply"
                                color: card.applyReady ? pill.textColor : Theme.faint
                                font.family: Theme.font
                                font.pixelSize: 10.5 * root.s
                                font.weight: Font.DemiBold
                                font.letterSpacing: 0.3 * root.s
