    ...
    Item {
        ...
        Row {
            ...
            Text {
                ...
                color: root.discovering ? Theme.vermLit : pill.subTextColor
                font.family: Theme.font
                        ...
                        Rectangle {
                            ...
                            Rectangle {
                                ...
                                GlyphIcon {
                                    ...
                                    color: devItem.isConnected ? Theme.vermLit : pill.iconColor
                                    stroke: 1.7
                                }
                            }
                            ...
                            Column {
                                ...
                                Text {
                                    ...
                                    color: devItem.isConnected ? pill.textColor : pill.subTextColor
                                    font.family: Theme.font
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    Text {
                                        ...
                                        anchors.centerIn: parent
                                        text: "Pair"
                                        color: pairArea.containsMouse ? pill.textColor : pill.subTextColor
                                        font.family: Theme.font
                                        font.pixelSize: 9.5 * root.s
                                        font.weight: Font.DemiBold
                                    }
