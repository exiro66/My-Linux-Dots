...
PillSurface {
    ...
    SearchField {
        ...
        Item {
            ...
            readonly property color tone: holding ? Theme.vermLit : (wipeArea.containsMouse ? pill.textColor : Theme.faint)
            ...
            Item {
                ...
                Text {
                    ...
                    color: row.entry !== undefined && row.entry.isImage
                        ? (row.selected ? pill.subTextColor : Theme.faint)
                        : (row.selected ? pill.textColor : pill.subTextColor)
                    font.family: Theme.font
                ...
                Item {
                    ...
                    Text {
                        ...
                        text: "✕"
                        color: dismissArea.containsMouse ? pill.textColor : pill.subTextColor
