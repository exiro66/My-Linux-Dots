...
PillSurface {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: opt.current ? pill.textColor : pill.subTextColor
    ...
    component AudioRow: Item {
        ...
        GlyphIcon {
            ...
            height: 16 * root.s
            name: arow.glyph
            color: arow.on ? Theme.vermLit : pill.iconColor
            stroke: 1.7
        }
        ...
        Text {
            ...
            width: 76 * root.s
            text: arow.name
            color: arow.on ? pill.textColor : pill.subTextColor
            font.family: Theme.font
        ...
        Item {
            ...
            Row {
                ...
                Text {
                    ...
                    color: ScreenRec.recording ? Theme.vermLit : pill.subTextColor
                    font.family: Theme.font
                    font.pixelSize: 10 * root.s
                    font.weight: Font.Bold
                    font.capitalization: Font.AllUppercase
        ...
        Item {
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                GlyphIcon {
                                    ...
                                    color: srcArea.containsMouse ? Theme.vermLit : pill.iconColor
                                    stroke: 1.7
                                }
                                Text {
                                    height: 16 * root.s
                                    ...
                                    color: srcArea.containsMouse ? pill.textColor : pill.subTextColor
                                    font.family: Theme.font
            ...
            Rectangle {
                ...
                GlyphIcon {
                    ...
                    height: 12 * root.s
                    name: "chevron-left"
                    color: backArea.containsMouse ? pill.textColor : Theme.faint
                    stroke: 2
        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    text: "CHANGE"
                    color: changeArea.containsMouse ? Theme.flameGlow : pill.subTextColor
                    font.family: Theme.font
                    font.pixelSize: 9 * root.s
                    font.weight: Font.Bold
                    font.capitalization: Font.AllUppercase
                ...
                Text {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    text: "OPEN"
                    color: openArea.containsMouse ? Theme.flameGlow : pill.subTextColor
                    font.family: Theme.font
                    font.pixelSize: 9 * root.s
                    font.weight: Font.Bold
                    font.capitalization: Font.AllUppercase
                ...
                delegate: Item {
                    ...
                    ClippingRectangle {
                        ...
                        GlyphIcon {
                            ...
                            visible: !frame.coverReady
                            name: "play"
                            color: frameArea.containsMouse ? pill.textColor : pill.iconColor
                        }
                    ...
                    Rectangle {
                        ...
                        GlyphIcon {
                            ...
                            name: "close"
                            stroke: 2
                            color: frame.armed || delClipArea.containsMouse ? pill.textColor : pill.subTextColor
                        }
