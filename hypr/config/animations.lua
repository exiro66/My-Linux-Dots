...
-- Cierre: sin desplazamiento (popin sutil) + desvanecido real vía fadeOut.
hl.animation({ leaf = "windowsOut", enabled = true, speed = 4.5, bezier = "smooth", style = "popin 87%" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 5.5, bezier = "smooth" })
